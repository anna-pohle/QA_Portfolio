...
class CheckoutPage(BasePage):
    ...
    def fill_address(self, street: str, city: str, postal_code: str):
        # Füllt die Adressfelder aus"
        self.street_input.fill(street)
        self.city_input.fill(city)
        self.postal_code_input.fill(postal_code)

    def fill_payment(self, card_number: str, name_on_card: str, expiration: str, cvv: str):
    ...
    def complete_checkout(self, address_data: dict, payment_data: dict):
        # Füllt alle Felder mit den Testdaten aus und schließt Checkout ab
